...
const TIPS = [
  {
    id: 'invite',
    text: 'Poker is better with friends — start a private room and invite them.',
    primary: { action: 'invite', label: 'Invite friends' },
    secondary: { action: 'share', label: 'Share site' },
  },
  {
    id: 'share',
    text: 'Enjoying the table? Share Poker Games Club so others can deal in.',
    primary: { action: 'share', label: 'Share' },
    secondary: { action: 'copy', label: 'Copy link' },
  },
  {
    id: 'open',
    text: 'Want live opponents? Drop into an open table anytime.',
    primary: { action: 'open', label: 'Open tables' },
    secondary: { action: 'share', label: 'Share site' },
  },
  {
    id: 'win',
    text: 'Just won the table? Challenge a friend next — private rooms are free.',
    primary: { action: 'invite', label: 'Invite a friend' },
